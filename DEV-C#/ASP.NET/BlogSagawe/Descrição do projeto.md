...
1.1.6 - DataPost => removido da página de criação;
1.1.7 - UsuarioCriador;

# Nota foi preciso alterar a string do banco de dados appsettings.json.

1.2 - Categoria's
1.2.1 - IdCategoria
1.2.2 - Categoria
1.2.3 - Descrição da categoria

=================

2 - View's
2.1 - Apresentar no menu superior o item post    

2.2.1 - Index deve conter:
2.2.1.1 - NomePost;
2.2.1.2 - Categoria;
2.2.1.3 - Autor;
2.2.1.4 - Data da Criação;

2.3.1 - View da categoria
2.3.1.1 - Index só para o administrador;
2.3.1.2 - Criação de categoria para usuários comuns deve estar em uma modal na pagina da criação do post
...
3 - Autenticação de Usuários por contas Individual;

4 - Cada Usuário pode editar e deletar apenas seus posts;
